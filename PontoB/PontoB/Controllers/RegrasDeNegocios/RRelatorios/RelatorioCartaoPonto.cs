...
{
    public class RelatorioCartaoPonto
    {
        ...
        public CartaoPonto CartaoPonto(DateTime dataInicio, DateTime dataFim, int colaboradorId)
        {
        ...
        private IList<ModalEscalaColaboradorViewModel> EscalaColaborador(int escalaId)
        {
        ...
        private string StringPontoRegistroViewModel(IList<RegistroPonto> filtro)
        {
